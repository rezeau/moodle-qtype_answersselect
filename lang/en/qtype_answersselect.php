...
$string['correctchoicesseparator_help'] = '<p>This separator will be used to separate the right answers displayed to the student if that review option is selected in the Quiz.</p><ul><li>The comma is the default option, to be used for short right answers.</li><li>Use the blank space if the (ordered) right answers are single words making up a sentence.</li><li>Use the line break for longer right answers making a better display on separate lines.</li></ul>';
...
$string['pluginnamesummary'] = '<p>A multiple-choice, multiple-response question type with particular scoring rules.</p><p>Recommended if your question has a "pool" of correct and incorrect answers from which a set number can be selected at runtime.</p>';
