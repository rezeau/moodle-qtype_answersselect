@ou @ou_vle @qtype @qtype_answersselect @_switch_window @javascript
Feature: Preview an OU multiple response question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | answersselect | answersselect 001 | two_of_four |
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "Question bank" in current page administration

  Scenario: Preview a question and submit a partially correct response.
    When I choose "Preview" action for "answersselect 001" in the question bank
  ...
  Scenario: Preview a question and submit a partially correct response and has partially correct feedback number.
    When I choose "Edit question" action for "answersselect 001" in the question bank
