...
require_once($CFG->dirroot . '/question/type/answersselect/tests/helper.php');
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_shows_standard_instruction_yes(): void {
    ...
    public function test_shows_standard_instruction_no(): void {
...
*/
    public function test_interactive_bug_11263(): void {
        ...
        // Create an answersselect question.
        $mc = test_question_maker::make_question('answersselect', 'letters_two_of_five');
        $mc->penalty = 1;
        $mc->answersselectmode = 0;
        $mc->randomselectcorrect = 0;
        $mc->randomselectincorrect = 0;
    ...
    public function test_interactive_regrade_changing_num_tries_leaving_open(): void {
        ...
        $q = test_question_maker::make_question('answersselect', 'letters_two_of_five');
