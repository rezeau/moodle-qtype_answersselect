...
class mobile {
    ...
    public static function oumr_view() {
        ...
        return [
            'templates' => [[
                'id' => 'main',
                'html' => file_get_contents($CFG->dirroot . '/question/type/answersselect/mobile/oumr.html')
            ]],
            'javascript' => file_get_contents($CFG->dirroot . '/question/type/answersselect/mobile/oumr.js')
        ];
    }
}
